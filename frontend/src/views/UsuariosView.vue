...
.usuarios-view :deep(.p-datatable) {
  background-color: white !important;
}
.usuarios-view :deep(.p-datatable-table) {
  background-color: white !important;
}
.usuarios-view :deep(.p-datatable-thead > tr > th) {
  background-color: #f8fafc !important;
  color: #1e293b !important;
  border-bottom: 2px solid #e2e8f0 !important;
}
.usuarios-view :deep(.p-datatable-tbody > tr) {
  background-color: white !important;
  color: #1e293b !important;
}
.usuarios-view :deep(.p-datatable-tbody > tr:hover) {
  background-color: #f1f5f9 !important;
}
.usuarios-view :deep(.p-paginator) {
  background-color: white !important;
  color: #1e293b !important;
  border-top: 1px solid #e2e8f0 !important;
}
.usuarios-view :deep(.p-select),
.usuarios-view :deep(.p-select-overlay) {
  background-color: white !important;
  color: #1e293b !important;
  border: 1px solid #e2e8f0 !important;
}
.usuarios-view :deep(.p-select-option) {
  color: #1e293b !important;
}
.usuarios-view :deep(.p-select-option:hover) {
  background-color: #f1f5f9 !important;
}
.usuarios-view :deep(.p-select-label) {
  color: #1e293b !important;
}
.usuarios-view :deep(.p-placeholder) {
  color: #94a3b8 !important;
}
.usuarios-view :deep(.p-dialog) {
  background-color: white !important;
}
.usuarios-view :deep(.p-dialog-content) {
  background-color: white !important;
}

.usuarios-view :deep(.p-dialog-header) {
  background-color: white !important;
  color: #1e293b !important;
}
.usuarios-view :deep(.p-dialog) {
...
.usuarios-view :deep(.p-inputtext),
.usuarios-view :deep(.p-inputnumber-input) {
  background-color: white !important;
  color: #1e293b !important;
  border: 1px solid #e2e8f0 !important;
}
