...
.pendientes-view :deep(.p-datatable) {
  background-color: white !important;
}
.pendientes-view :deep(.p-datatable-table) {
  background-color: white !important;
}
.pendientes-view :deep(.p-datatable-thead > tr > th) {
  background-color: #f8fafc !important;
  color: #1e293b !important;
  border-bottom: 2px solid #e2e8f0 !important;
}
.pendientes-view :deep(.p-datatable-tbody > tr) {
  background-color: white !important;
  color: #1e293b !important;
}
.pendientes-view :deep(.p-datatable-tbody > tr:hover) {
  background-color: #f1f5f9 !important;
}
.pendientes-view :deep(.p-datatable-tbody > tr.fila-atrasada) {
  background-color: #fff5f5 !important;
}
.pendientes-view :deep(.p-paginator) {
  background-color: white !important;
  color: #1e293b !important;
  border-top: 1px solid #e2e8f0 !important;
}
.pendientes-view :deep(.p-select),
.pendientes-view :deep(.p-select-overlay) {
  background-color: white !important;
  color: #1e293b !important;
  border: 1px solid #e2e8f0 !important;
}
.pendientes-view :deep(.p-select-option) {
  color: #1e293b !important;
}
.pendientes-view :deep(.p-select-option:hover) {
  background-color: #f1f5f9 !important;
}
...
.pendientes-view :deep(.p-datatable .p-datatable-tbody > tr > td) {
